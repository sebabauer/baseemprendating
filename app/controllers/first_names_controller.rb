class FirstNamesController < ApplicationController
  ...
  private
    ...
    def first_name_params
      params.require(:first_name).permit(:last_name, :maiden_name, :formatted_name, :phonetic_first_name, :phonetic_last_name, :formatted_phonetic_name, :headline, :location, :industry, :current_share, :num_connections, :num_connections_capped, :sumary, :specialties, :positions, :picture_url, :picture_url_original, :site_standard_profile_request, :api_standard_profile_request, :public_profile_url, :email_address)
    end
end
